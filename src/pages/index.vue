      ...
      tableData:{
        columns: [
          ...
          },
          {
            ...
            customRender: (text) => {
              return {
                children: <img style="width:40px;height:40px" src={text}/>,
              };
            },
          },
          {
            ...
            key: 'putawayStatus',
            ellipsis:true,
            customRender: (text,record,index) => {//customRender:自定义加载数据函数：text：当前key值，record:当前对象,index:下标
              switch (text){
                case 1:
                  return <div>审核通过</div>
                  break;
        ...
        //定义表格的宽高，限制x轴、y轴超出设定的宽度值时显示滚动条 ，注意：外层容易一定要设置相应宽度才有效
        scroll:{ x:800,y:300 },
        totalElements:0,
